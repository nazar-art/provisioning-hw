...
public class ProvisioningServiceImplTest {
    ...
    public void testThatConfigurationFileIsAutogeneratedFineWithJsonFormatOverride() {
        Device device = Device.builder()
                .macAddress("mac-address-json-format")
                .username("harry")
                .password("potter")
                .model(Device.DeviceModel.DESK)
        ...
        assertThat(provisioningService.getProvisioningFile("mac-address-json-format"), is(expectedResponse));
    }

    @Test
    public void testThatConfigurationFileIsAutogeneratedFineWithPropertiesFormatOverride() {
        Device device = Device.builder()
                .macAddress("mac-address-properties-format")
                .username("harry")
                .password("potter")
                .model(Device.DeviceModel.DESK)
        ...
        assertThat(provisioningService.getProvisioningFile("mac-address-properties-format"), is(expectedResponse));
    }
    ...
    public void ifMacAddressIsWrongThrowException() {
        provisioningService.getProvisioningFile("incorrect-mac-address");
    }
}