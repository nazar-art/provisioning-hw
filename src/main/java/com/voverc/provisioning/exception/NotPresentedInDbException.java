 ...
 * @author Nazar Lelyak.
 */
@ResponseStatus(value = HttpStatus.NOT_FOUND, reason = "device is not found")
public class NotPresentedInDbException extends RuntimeException {

    private static final long serialVersionUID = 1L;

    private static final String STATION_NOT_FOUND_EXCEPTION = "Device, with mac address: %s is NOT FOUND in DB.";
